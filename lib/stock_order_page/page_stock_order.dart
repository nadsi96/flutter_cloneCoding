      ...
      child: Row(
        ...
        children: [
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                      ...
                      child: Obx((){
                        return RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: ' [위탁계좌] 국내${myPageController.user.value.name} 가나다라마바사아자차카타파하',
                                style: const TextStyle(fontSize: 14, color: BLACK, fontWeight: FontWeight.normal),
                              ),
                            ],
                          ),
                        );
                    ...
                    const Icon(Icons.keyboard_arrow_down, color: GRAY, size: 18),
                  ],
                ),
              ),
            ),
          ...
          Container( // 비밀번호
            ...
            width: 120,
            decoration: BoxDecoration(
              border: Border.all(color: GRAY), color: WHITE, borderRadius: BorderRadius.circular(3),
            ),
            ...
            child: Row(
              children: [
                const Expanded(
                  child: Text('비밀번호', style: TextStyle(fontSize: 14, color: GRAY), textAlign: TextAlign.center),
                ),
                Container(
                  width: 30,
                  height: 30,
                  decoration: BoxDecoration(color: LLIGHTGRAY, border: Border.all(color: GRAY), borderRadius: BorderRadius.circular(3),),
                  alignment: Alignment.center,
                  child: const Icon(Icons.lock_outline, color: DARKGRAY, size: 20),
                ), // 비밀번호
              ],
            ),
          ),
